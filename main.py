...
content = {
    ...
    "kr": {
        ...
        "menu": {"home": "홈", "about": "사이트 소개", "tips": "여행 유의사항", "checklist": "여행 체크리스트", "lang": "언어", "food": "현지 음식", "health": "의료 지원"},
        "about": [
			{"title": "회사 소개",
			"decs": """
        ...
        "places": [
            {"name": "Can Tho", "img": "cantho.jpg",
             "desc": "껀터는 메콩델타의 중심 도시로서 수상시장과 풍요로운 과수원 그리고 따뜻한 농촌 문화로 유명한 도시입니다. 여행객들은 아침 수상시장을 체험하고 배 위에서 분리우와 신선한 열대 과일을 맛볼 수 있습니다."},
            {"name": "An Giang", "img": "nuicamangiang.jpg",
             "desc": "안장은 칠산의 산악 지역으로 참 문화와 크메르 문화가 어우러진 곳이며 신성한 자연 경관과 평화로운 강 생활로 유명한 지역입니다."},
            {"name": "Ca Mau", "img": "muicamau.jpg",
             "desc": "까마우는 베트남의 최남단에 위치한 지역으로 세 면이 바다와 접해 있으며 맹그로브 숲, 석호 작은 섬들이 발달한 자연 생태로 유명합니다."},
            {"name": "Vinh Long", "img": "vinhlong.jpg",
             "desc": "빈롱은 띠엔강과 하우강 사이에 위치한 지역으로 메콩델타 수상 문화의 중심지입니다. 이곳은 수많은 운하와 수로 풍성한 과일 정원 평화로운 농원 풍경으로 유명합니다."},
            {"name": "Dong Thap", "img": "dongthap.jpg",
             "desc": "동탑은 연꽃 및 사덱 꽃마을 고탑 오크에오 유적지와 친환경 공동체 관광으로 유명한 지역입니다."}
        ],
        "tips": [
            {
                "title": "1. 출발 전",
...
place_details_data = {
    ...
    "kr": {
		"Can Tho": [
			{ "title": "닌끼에우 부두 – 도시의 상징",
			"desc": """
			<p>닌끼에우 부두는 온화한 허우강 옆에 위치한 깐토의 상징적인 장소로 산책과 풍경 감상, 사진 촬영을 하기에 좋은 곳입니다.</p>
			<img src="/static/images/benninhkieu.jpg" class="detail-img" alt="닌끼우 부두의 파노라마 전망">
			<p>📍 위치: 껀터 시내 중심부 허우강 강변에 위치해 있습니다.</p>
			<p>주요 특징:</p>
			<ul>
				<li>닌끼에우 보행자 다리는 밤이 되면 화려한 조명으로 아름다운 야경을 보여줍니다..</li>
				<li>이곳에서는 수상시장으로 가는 배를 타거나 허우강 유람선을 즐길 수 있습니다.</li>
				<li>공원에는 호치민 주석 동상이 있으며 넓고 시원한 휴식 공간이 마련되어 있습니다.</li>
				</ul>
				<img src="/static/images/bac_ho.jpg" class="detail-img" alt="깐토 공원의 호 아저씨 동상">
				<p>추천:</p>
			<ul>
				<li>방문 시간은 하루 종일 가능하지만 특히 저녁 시간이 가장 아름답습니다</li>
				<li>저녁에는 유람선에서 식사를 하며 강의 야경을 감상하는 것을 추천합니다.</li>
				<li>주말 저녁에는 거리 공연과 음악 공연도 즐길 수 있습니다.</li>
			</ul>
			"""},
			...
			"""},
			{ "title": "도이 사원 – 독특한 크메르 사원",
			"desc": """
			<p>도이 사원은 400년 이상의 역사를 가진 크메르 사원으로 수천 마리의 박쥐가 나무에 매달려 사는 것으로 유명합니다.</p>
			<p>📍위치: 속짱시 3구에 위치하며 도심에서 약 2km 떨어져 있습니다.</p>
			<p>역사와 건축:</p>
			<ul>
				<li>이 사원은 16세기에 건립된 대표적인 남방 불교 크메르 사원입니다.</li>
				<li>본당은 크메르 전통 건축 양식을 보여주며 여러 층의 곡선 지붕과 정교한 장식이 특징입니다.</li>
				<li>사원 안에는 귀중한 오래된 불상들도 보관되어 있습니다.</li>
			</ul>			
			<img src="/static/images/chuadoi.jpg" class="detail-img" alt="속짱 박쥐 사원">
			<p>주요 특징:</p>
			<ul>
				<li>사원 주변에는 큰 박쥐들이 집단으로 서식하고 있습니다.</li>
				<li>박쥐는 낮에는 나무에 매달려 있고 저녁이 되면 먹이를 찾으러 날아갑니다.</li>
			</ul>
			<p>추천:</p>
			<ul>
				<li>방문은 아침이나 시원한 오후 시간이 좋습니다.</li>
				<li>사원을 방문할 때는 단정한 복장을 하고 조용히 관람해야 합니다.</li>
			</ul>
			"""},
			{ "title": "룽응옥호앙 자연보호구역",
			"desc": """
			<p>룽응옥호앙은 메콩델타의 ‘녹색 허파’라고 불리는 곳으로 풍부한 습지 숲 생태계를 가지고 있습니다. 자연 환경이 매우 원시적이며 수로가 많아 생태 관광에 매우 적합한 곳입니다.  방문객들은 보트를 타고 숲을 탐험하거나 새를 관찰하고 자연 풍경을 사진으로 남길 수 있습니다.</p>
			<p>📍위치: 허우장성 풍히엡 지역에 위치해 있습니다.</p>
			<img src="/static/images/lungngochoang.jpg" class="detail-img" alt="룽 응옥 호앙 자연 보호 구역">
			<p>주요 특징:</p>
			<ul>
				<li>약 2,800헥타르 규모의 습지 숲을 보유하고 있습니다.  자연 환경이 매우 풍부하며 다양한 생물 종이 서식하고 있습니다.</li>
				<li>천부적인 자연적 가치 - 희귀한 생물 다양성 보존</li>
			</ul>
			<p>추천:</p>
			<ul>
				<li>방문하기 좋은 시간은 이른 아침이나 늦은 오후입니다.</li>
				<li>곤충 기피제와 미끄럼 방지 신발을 준비하는 것이 좋습니다.</li>
				<li>자연 보호를 위해 환경을 깨끗이 유지하고 야생 동물을 방해하지 않아야 합니다.</li>
			</ul>
			"""}
			],
			"Ca Mau": [
