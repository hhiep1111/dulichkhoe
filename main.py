...
content = {
    ...
    {"text": "3. Khi lưu trú", "img": None},
    {"text": "Chọn khách sạn/nhà nghỉ an toàn: có đánh giá tốt, hệ thống an ninh.", "img": None},
    {"text": "Khóa cửa cẩn thận khi ra ngoài và cả khi ở trong phòng.", "img": None},
    {"text": "Không tiết lộ số phòng với người lạ.", "img": None},
    {"text": "4. Khi tham quan", "img": None},
    {"text": "Không mang theo quá nhiều tiền mặt hoặc đồ quý giá.", "img": None},
    {"text": "Cẩn thận với túi xách, balo ở nơi đông người (chợ, lễ hội, bến xe).", "img": None},
    {"text": "Tuân thủ quy định địa phương: không xả rác, không leo trèo nguy hiểm, tôn trọng văn hóa bản địa.", "img": None},
    {"text": "Luôn đi theo nhóm nếu ở nơi vắng vẻ hoặc không quen thuộc.", "img": None},
    {"text": "5. An toàn công nghệ", "img": None},
    {"text": "Không dùng Wi-Fi công cộng để giao dịch tài chính.", "img": None},
    {"text": "Cẩn thận khi chia sẻ vị trí trên mạng xã hội để tránh kẻ xấu lợi dụng.", "img": None}
],
        "checklist": [
